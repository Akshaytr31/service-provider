...
export default function ProviderSignupPage() {
  ...
  const handleChange = (e) => {
    ...
    setFormData((prev) => ({
      ...
      [name]:
        type === "checkbox"
          ? name === "paymentMethods" || name === "availableDays"
            ? prev[name]
            : checked
          : value,
    }));
  ...
  const handleArrayCheck = (arrName, val) => {
    setFormData((prev) => {
      ...
      if (arr.includes(val))
        return { ...prev, [arrName]: arr.filter((x) => x !== val) };
            ...
            <HStack wrap="wrap">
              {["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"].map((day) => (
                <Checkbox
                  ...
                  onChange={() => handleArrayCheck("availableDays", day)}
                >
                  {day}
                </Checkbox>
              ))}
      ...
      case 7: // Pricing
        return (
          <Stack spacing={4}>
            ...
            <Input
              name="baseRate"
              placeholder="Base Rate / Price Range"
              onChange={handleChange}
            ...
            <HStack>
              <Checkbox
                isChecked={formData.paymentMethods?.includes("Bank")}
                onChange={() => handleArrayCheck("paymentMethods", "Bank")}
              >
                Bank
              </Checkbox>
              <Checkbox
                isChecked={formData.paymentMethods?.includes("Cash")}
                onChange={() => handleArrayCheck("paymentMethods", "Cash")}
              >
                Cash
              </Checkbox>
              <Checkbox
                isChecked={formData.paymentMethods?.includes("UPI")}
                onChange={() => handleArrayCheck("paymentMethods", "UPI")}
              >
                UPI
              </Checkbox>
            </HStack>
