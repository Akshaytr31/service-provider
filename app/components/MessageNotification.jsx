  ...
  const fetchConversations = async (silent = false) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        // Simple logic: if new message count > old count, show badge?
        // Or just show total conversations as badge for now (as "active chats")
        // Real unread status needs DB schema update.
        // For V1: Just show total active chats.
